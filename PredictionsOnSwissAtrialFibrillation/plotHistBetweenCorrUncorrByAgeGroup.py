...
def main() -> None:
    ...
    for source_tag, csv_name, source_title in DATA_SOURCES:
        ...
        for age_label, age_lo, age_hi in AGE_GROUPS:
            ...
            title = f"Brain-Age Gap - Differences on the {source_title}, Age {age_label} - {dir_label}"
            out_path = os.path.join(args.output_dir, f"{dir_label}_hist_uncorVsCor_{source_tag}_age{age_label}.png")
