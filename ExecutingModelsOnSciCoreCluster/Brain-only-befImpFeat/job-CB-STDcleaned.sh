...
# ---------------------------------------------------------------------------
#SBATCH --job-name=BOTH_CB_beImpFeat_STDcleaned-GS9         # A name for your job. Shows up in `squeue`
...
TARGET="BOTH_CB_beImpFeat_STDcleaned-GS9"
srun python CatBoost_age_model_modelling.py \
  --input BOTH_befImpFeat-STDcleaned.csv \
  --output_dir "$TARGET" \
  --iterations 8400 12400 16400 \
