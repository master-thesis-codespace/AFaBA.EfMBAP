...
# ---------------------------------------------------------------------------
#SBATCH --job-name=BOTH_ET_beImpFeat_FEMALE-GS9         # A name for your job. Shows up in `squeue`
...
TARGET="BOTH_ET_beImpFeat_FEMALE-GS9"
srun python ExtraTree_age_model_modelling.py \
  --input BOTH_befImpFeat-FEMALE.csv \
  --output_dir  "$TARGET" \
  --n_estimators 3190 3200 3210 \
  --max_depth 19 20 21 \
