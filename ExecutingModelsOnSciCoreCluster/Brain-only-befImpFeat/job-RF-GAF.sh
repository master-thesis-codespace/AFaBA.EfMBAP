...
# ---------------------------------------------------------------------------
#SBATCH --job-name=BOTH_RF_beImpFeat_GAF-GS11         # A name for your job. Shows up in `squeue`
...
TARGET="BOTH_RF_beImpFeat_GAF-GS11"
srun python RandomForest_age_model_modelling-GAF.py \
  --input BOTH_befImpFeat-XB.csv \
  --output_dir "$TARGET" \
  --n_estimators 2262 2264 2266 \
  --max_depth 19 20 21 \
