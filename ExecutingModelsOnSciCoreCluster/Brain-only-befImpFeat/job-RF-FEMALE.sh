...
# ---------------------------------------------------------------------------
#SBATCH --job-name=BOTH_RF_beImpFeat_FEMALE-GS9         # A name for your job. Shows up in `squeue`
...
TARGET="BOTH_RF_beImpFeat_FEMALE-GS9"
srun python RandomForest_age_model_modelling.py \
  --input BOTH_befImpFeat-FEMALE.csv \
  --output_dir "$TARGET" \
  --n_estimators 339 340 341 \
  --max_depth 25 26 27 \
