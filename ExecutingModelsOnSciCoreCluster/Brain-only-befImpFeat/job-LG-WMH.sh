...
# ---------------------------------------------------------------------------
#SBATCH --job-name=BOTH_LG_beImpFeat_WMH-GS7         # A name for your job. Shows up in `squeue`
...
TARGET="BOTH_LG_beImpFeat_WMH-GS7"
srun python LightGBM_age_model_modelling.py \
  --input BOTH_befImpFeat-WMH.csv \
  --output_dir "$TARGET" \
  --n_estimators 9000 13000 17000 \
