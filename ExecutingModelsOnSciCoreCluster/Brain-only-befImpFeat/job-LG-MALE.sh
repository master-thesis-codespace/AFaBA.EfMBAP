...
# ---------------------------------------------------------------------------
#SBATCH --job-name=BOTH_LG_beImpFeat_MALE-GS7         # A name for your job. Shows up in `squeue`
...
TARGET="BOTH_LG_beImpFeat_MALE-GS7"
srun python LightGBM_age_model_modelling.py \
  --input BOTH_befImpFeat-MALE.csv \
  --output_dir "$TARGET" \
  --n_estimators 4400 4500 4600 \
