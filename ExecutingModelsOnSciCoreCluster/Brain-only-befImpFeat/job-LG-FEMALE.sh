...
# ---------------------------------------------------------------------------
#SBATCH --job-name=BOTH_LG_beImpFeat_FEMALE-GS8         # A name for your job. Shows up in `squeue`
...
TARGET="BOTH_LG_beImpFeat_FEMALE-GS8"
srun python LightGBM_age_model_modelling.py \
  --input BOTH_befImpFeat-FEMALE.csv \
  --output_dir "$TARGET" \
  --n_estimators 7000 8000 9000 \
