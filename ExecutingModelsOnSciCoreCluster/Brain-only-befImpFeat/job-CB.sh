...
# ---------------------------------------------------------------------------
#SBATCH --job-name=BOTH_CB_beImpFeat_GAF-GS9         # A name for your job. Shows up in `squeue`
...
TARGET="BOTH_CB_beImpFeat_GAF-GS9"
srun python CatBoost_age_model_modelling-GAF.py \
  --input BOTH_befImpFeat-CB.csv \
  --output_dir "$TARGET" \
  --iterations 16400 17400 18400 \
