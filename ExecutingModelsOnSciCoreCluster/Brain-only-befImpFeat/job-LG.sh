...
# ---------------------------------------------------------------------------
#SBATCH --job-name=BOTH_LG_beImpFeat_GAF-GS8         # A name for your job. Shows up in `squeue`
...
TARGET="BOTH_LG_beImpFeat_GAF-GS8"
srun python LightGBM_age_model_modelling-GAF.py \
  --input BOTH_befImpFeat-LG.csv \
  --output_dir "$TARGET" \
  --n_estimators 74000 78000 82000 \
