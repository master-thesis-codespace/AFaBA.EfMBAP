...
# ---------------------------------------------------------------------------
#SBATCH --job-name=BOTH_XB_beImpFeat_GAF-GS12         # A name for your job. Shows up in `squeue`
...
TARGET="BOTH_XB_beImpFeat_GAF-GS12"
srun python XGBoost_age_model_modelling-GAF.py \
  --input BOTH_befImpFeat-XB.csv \
  --output_dir "$TARGET" \
  --n_estimators 6750 6780 6820 6850 \
