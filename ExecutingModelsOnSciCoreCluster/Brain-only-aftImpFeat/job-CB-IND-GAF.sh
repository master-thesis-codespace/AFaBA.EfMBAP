...
# ---------------------------------------------------------------------------
#SBATCH --job-name=BRAIN_CB_aftImpFeat_IND_GAF-GS4_         # A name for your job. Shows up in `squeue`
...
#SBATCH --time=16:00:00                  # Maximum wall-clock time (HH:MM:SS). When this is hit,
...
TARGET="BRAIN_CB_aftImpFeat_IND_GAF-GS4<-"
srun python CatBoost_age_model_modelling-GAF.py \
  --input BRAIN_INDIVIDUALaftImpFeat_GAF-CB.csv \
  --output_dir "$TARGET" \
  --iterations 5000 6000 7000 \
  --learning_rate 0.02 0.03 0.04 \
  --depth 4 5 6 \
  --l2_leaf_reg 14 15 16 \
